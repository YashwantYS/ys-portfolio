...
export const caseStudies = [
  ...
  },
  {
    ...
    title: 'CB Nexus',
    headline: 'Company-Wide Recruitment Operating Platform',
    description: 'A modular, role-based operating system for a 35+ person recruiting team, built on Google Apps Script with a pluggable module architecture. Consolidates attendance, leave, sourcing, compliance training, client intelligence, and admin controls into a single application, gated by role-based permissions. Production access is restricted because the platform runs the internal operations of the company.',
    problem: 'Recruitment operations were spread across a dozen disconnected spreadsheets, forms, and manual processes — different tools for attendance, leave, sourcing requirements, compliance training, and client knowledge. No unified permission model, no single source of truth, and every new tool meant another spreadsheet to maintain.',
    solution: 'Designed and built a single-page application with a pluggable module registry, so every function of the business — attendance, leave, sourcing, screening, compliance, gamified client-knowledge training — runs as an independently loadable module behind one role-based permission system (Recruiter / Account Manager / HR / Admin).',
    tech: ['Google Apps Script', 'Google Sheets', 'JavaScript', 'CacheService', 'LockService', 'HTML/CSS'],
    architecture: [
      { layer: 'Frontend', items: ['Modular SPA', 'HTML/CSS/JS'], color: 'cyan' },
      { layer: 'Backend', items: ['Apps Script', 'MODULE_REGISTRY'], color: 'indigo' },
      { layer: 'Database', items: ['Google Sheets'], color: 'green' },
      { layer: 'Concurrency', items: ['LockService', 'CacheService'], color: 'purple' },
      { layer: 'Access', items: ['Role-Based Permissions'], color: 'orange' },
    ],
    features: [
      'Pluggable Module Registry Architecture',
      'Role-Based Access (Recruiter/AM/HR/Admin)',
      'Gamified Weekly Client Intelligence Quiz with Leaderboards',
      'Recruitment Load Balancer with Nightly Auto-Assignment',
      'PoSH Compliance Training with Progress Tracking',
      'Screening Center with Indexed Fuzzy Search',
      'Attendance & Leave Management',
      'Production Security Audit (Auth Guards, Concurrency Locking)',
    ],
    impact: 'Replaced a dozen disconnected spreadsheets with one platform. Cut reporting and lookup time from minutes to seconds, standardized permissions across the team, and gave leadership a single operational command center.',
    featured: true,
  },
  {
    id: 'leave-management',
